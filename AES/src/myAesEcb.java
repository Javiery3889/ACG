...
public class myAesEcb
{
  public static void main (String[] args) throws Exception
  {
	...
	String text = String.join("",Collections.nCopies(50,"1"));
    ...
    // Consider using asHex() method
      ...
      System.out.println("AES key:" + myAesEcb.asHex(mykey.getEncoded()));
    ...
    for (int i=0;i<ciphertext.length;i++) {
		System.out.print("["+ciphertext[i]+ ", " + i + "] "); //data size, for 256 also repeat by 256
	}
