/***************************************************************
 *
 * A Simple Program on Asymmetric Encryption
 *
 ...
 ***************************************************************/
 ...
 public class myRsaStud
 {
   public static void main (String[] args) throws Exception
   {
    ...
    KeyPair RSAKeyPair = keyPairGenerator.genKeyPair();
    Key RSApub = RSAKeyPair.getPublic();
    Key RSApriv = RSAKeyPair.getPrivate();
